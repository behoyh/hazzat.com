...
namespace PanoramaApp1
{
    public partial class App : Application
    {
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            ...
            MessageBox.Show("This app uses a constant internet connection. Please connect to the internet to use this app. {Error Detail: " + e.ExceptionObject.Message +"} This application will now close.");
        }
